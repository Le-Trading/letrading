 ...
 */
final class Version20200302152924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE notif (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, post_id INT NOT NULL, receiver_id INT NOT NULL, type VARCHAR(255) NOT NULL, checked TINYINT(1) NOT NULL, date DATETIME NOT NULL, INDEX IDX_C0730D6BF624B39D (sender_id), INDEX IDX_C0730D6B4B89032C (post_id), INDEX IDX_C0730D6BCD53EDB6 (receiver_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
